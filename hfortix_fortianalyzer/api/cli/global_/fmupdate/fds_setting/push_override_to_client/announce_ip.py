"""
FortiAnalyzer API endpoint: cli.global.fmupdate.fds-setting.push-override-to-client.announce-ip
...
class CliGlobalFmupdateFdsSettingPushOverrideToClientAnnounceIp:
    ...
    def get(
        ...
        if announce_ip is not None:
            url = "/cli/global/fmupdate/fds-setting/push-override-to-client/announce-ip/{announce-ip}"
            url = url.replace("{announce-ip}", str(announce_ip))
        else:
            url = "/cli/global/fmupdate/fds-setting/push-override-to-client/announce-ip"
    ...
    def delete(self, announce_ip: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
