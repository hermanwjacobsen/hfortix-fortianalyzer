"""
FortiAnalyzer API endpoint: cli.global.fmupdate.fgd-setting.server-override.servlist
...
class CliGlobalFmupdateFgdSettingServerOverrideServlist:
    ...
    def get(
        ...
        if servlist is not None:
            url = "/cli/global/fmupdate/fgd-setting/server-override/servlist/{servlist}"
            url = url.replace("{servlist}", str(servlist))
        else:
            url = "/cli/global/fmupdate/fgd-setting/server-override/servlist"
