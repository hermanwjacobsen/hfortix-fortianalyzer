"""
FortiAnalyzer API endpoint: cli.global.system.local-in-policy6.dst
...
class CliGlobalSystemLocalInPolicy6Dst:
    ...
    def get(
        ...
        if local_in_policy6 is not None and dst is not None:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/dst/{dst}"
            url = url.replace("{local-in-policy6}", local_in_policy6)
            url = url.replace("{dst}", str(dst))
        else:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/dst"
            url = url.replace("{local-in-policy6}", local_in_policy6)
    ...
    def delete(self, local_in_policy6: str, dst: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
