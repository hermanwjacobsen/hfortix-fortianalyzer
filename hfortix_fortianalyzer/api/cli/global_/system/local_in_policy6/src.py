"""
FortiAnalyzer API endpoint: cli.global.system.local-in-policy6.src
...
class CliGlobalSystemLocalInPolicy6Src:
    ...
    def get(
        ...
        if local_in_policy6 is not None and src is not None:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/src/{src}"
            url = url.replace("{local-in-policy6}", local_in_policy6)
            url = url.replace("{src}", str(src))
        else:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/src"
            url = url.replace("{local-in-policy6}", local_in_policy6)
    ...
    def delete(self, local_in_policy6: str, src: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
