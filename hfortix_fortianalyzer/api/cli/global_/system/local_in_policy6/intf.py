"""
FortiAnalyzer API endpoint: cli.global.system.local-in-policy6.intf
...
class CliGlobalSystemLocalInPolicy6Intf:
    ...
    def get(
        ...
        if local_in_policy6 is not None and intf is not None:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/intf/{intf}"
            url = url.replace("{local-in-policy6}", local_in_policy6)
            url = url.replace("{intf}", str(intf))
        else:
            url = "/cli/global/system/local-in-policy6/{local-in-policy6}/intf"
            url = url.replace("{local-in-policy6}", local_in_policy6)
    ...
    def delete(self, local_in_policy6: str, intf: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
