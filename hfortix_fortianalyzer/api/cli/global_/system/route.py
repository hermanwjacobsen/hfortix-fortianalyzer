"""
FortiAnalyzer API endpoint: cli.global.system.route
...
class CliGlobalSystemRoute:
    ...
    def get(
        ...
        if route is not None:
            url = "/cli/global/system/route/{route}"
            url = url.replace("{route}", str(route))
        else:
    ...
    def delete(self, route: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
