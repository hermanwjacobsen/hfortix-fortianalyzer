"""
FortiAnalyzer API endpoint: cli.global.system.admin.profile.write-passwd-profiles
...
class CliGlobalSystemAdminProfileWritePasswdProfiles:
    ...
    def get(
        ...
        Args:
            ...
            write_passwd_profiles: write-passwd-profiles parameter
        ...
        if profile is not None and write_passwd_profiles is not None:
            url = "/cli/global/system/admin/profile/{profile}/write-passwd-profiles/{write-passwd-profiles}"
            url = url.replace("{profile}", profile)
            url = url.replace("{write-passwd-profiles}", str(write_passwd_profiles))
        else:
            url = "/cli/global/system/admin/profile/{profile}/write-passwd-profiles"
            url = url.replace("{profile}", profile)
    ...
    def delete(self, profile: str, write_passwd_profiles: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
