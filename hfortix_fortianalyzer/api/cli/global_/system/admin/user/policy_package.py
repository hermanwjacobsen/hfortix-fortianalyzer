"""
FortiAnalyzer API endpoint: cli.global.system.admin.user.policy-package
...
class CliGlobalSystemAdminUserPolicyPackage:
    ...
    def get(
        ...
        Args:
            user: user parameter
            policy_package: policy-package parameter
        ...
        if user is not None and policy_package is not None:
            url = "/cli/global/system/admin/user/{user}/policy-package/{policy-package}"
            url = url.replace("{user}", user)
            url = url.replace("{policy-package}", str(policy_package))
        else:
            url = "/cli/global/system/admin/user/{user}/policy-package"
            url = url.replace("{user}", user)
    ...
    def add(
        ...
        Args:
            user: user parameter
            policy_package: policy-package parameter
            policy_package_name: policy-package-name parameter
        ...
        # Build data payload
        data = {}
        if policy_package_name is not None:
            data["policy-package-name"] = policy_package_name
    ...
    def delete(self, user: str, policy_package: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
