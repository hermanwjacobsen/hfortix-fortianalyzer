"""Type stubs for cli.global.system.log.settings.rolling-local"""
...
class CliGlobalSystemLogSettingsRollingLocalGetItem:
    """Item yielded when iterating over CliGlobalSystemLogSettingsRollingLocalGetResponse."""
...
class CliGlobalSystemLogSettingsRollingLocalGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLogSettingsRollingLocalGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLogSettingsRollingLocalGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLogSettingsRollingLocal:
    """FortiAnalyzer endpoint: cli.global.system.log.settings.rolling-local"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLogSettingsRollingLocalGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLogSettingsRollingLocal", "CliGlobalSystemLogSettingsRollingLocalGetResponse"]