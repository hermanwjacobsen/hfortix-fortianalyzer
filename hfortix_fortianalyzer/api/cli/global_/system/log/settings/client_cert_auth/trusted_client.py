"""
FortiAnalyzer API endpoint: cli.global.system.log.settings.client-cert-auth.trusted-client
...
class CliGlobalSystemLogSettingsClientCertAuthTrustedClient:
    ...
    def get(
        ...
        if trusted_client is not None:
            url = "/cli/global/system/log/settings/client-cert-auth/trusted-client/{trusted-client}"
            url = url.replace("{trusted-client}", str(trusted_client))
        else:
            url = "/cli/global/system/log/settings/client-cert-auth/trusted-client"
    ...
    def delete(self, trusted_client: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
