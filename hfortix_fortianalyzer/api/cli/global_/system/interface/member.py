"""
FortiAnalyzer API endpoint: cli.global.system.interface.member
...
class CliGlobalSystemInterfaceMember:
    ...
    def get(
        ...
        if interface is not None and member is not None:
            url = "/cli/global/system/interface/{interface}/member/{member}"
            url = url.replace("{interface}", interface)
            url = url.replace("{member}", str(member))
        else:
            url = "/cli/global/system/interface/{interface}/member"
            url = url.replace("{interface}", interface)
    ...
    def add(
        ...
        Args:
            interface: interface parameter
            member: member parameter
            interface_name: interface-name parameter
        ...
        if interface_name is not None:
            data["interface-name"] = interface_name
    ...
    def delete(self, interface: str, member: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
