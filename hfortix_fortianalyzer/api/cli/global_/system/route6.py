"""
FortiAnalyzer API endpoint: cli.global.system.route6
...
class CliGlobalSystemRoute6:
    ...
    def get(
        ...
        if route6 is not None:
            url = "/cli/global/system/route6/{route6}"
            url = url.replace("{route6}", str(route6))
        else:
            url = "/cli/global/system/route6"
    ...
    def delete(self, route6: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
