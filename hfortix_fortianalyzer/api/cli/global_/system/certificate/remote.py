"""
FortiAnalyzer API endpoint: cli.global.system.certificate.remote
...
class CliGlobalSystemCertificateRemote:
    ...
    def get(
        ...
        if remote is not None:
            url = "/cli/global/system/certificate/remote/{remote}"
            url = url.replace("{remote}", str(remote))
        else:
            url = "/cli/global/system/certificate/remote"
    ...
    def delete(self, remote: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
