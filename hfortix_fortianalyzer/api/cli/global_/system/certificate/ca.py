"""
FortiAnalyzer API endpoint: cli.global.system.certificate.ca
...
class CliGlobalSystemCertificateCa:
    ...
    def get(
        ...
        if ca is not None:
            url = "/cli/global/system/certificate/ca/{ca}"
            url = url.replace("{ca}", str(ca))
        else:
    ...
    def delete(self, ca: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
