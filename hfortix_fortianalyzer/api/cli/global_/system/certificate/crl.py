"""
FortiAnalyzer API endpoint: cli.global.system.certificate.crl
...
class CliGlobalSystemCertificateCrl:
    ...
    def get(
        ...
        if crl is not None:
            url = "/cli/global/system/certificate/crl/{crl}"
            url = url.replace("{crl}", str(crl))
        else:
            url = "/cli/global/system/certificate/crl"
    ...
    def add(
        ...
        Args:
            ...
            http_url: http-url parameter
            name: name parameter
            update_interval: update-interval parameter
    ...
    def delete(self, crl: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
