"""
FortiAnalyzer API endpoint: cli.global.system.certificate.local
...
class CliGlobalSystemCertificateLocal:
    ...
    def get(
        ...
        if local is not None:
            ...
            url = url.replace("{local}", str(local))
        else:
    ...
    def delete(self, local: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
