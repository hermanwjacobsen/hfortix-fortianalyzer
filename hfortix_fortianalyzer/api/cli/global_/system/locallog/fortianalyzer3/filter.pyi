"""Type stubs for cli.global.system.locallog.fortianalyzer3.filter"""
...
class CliGlobalSystemLocallogFortianalyzer3FilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogFortianalyzer3FilterGetResponse."""
...
class CliGlobalSystemLocallogFortianalyzer3FilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogFortianalyzer3FilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogFortianalyzer3FilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogFortianalyzer3Filter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.fortianalyzer3.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogFortianalyzer3FilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogFortianalyzer3Filter", "CliGlobalSystemLocallogFortianalyzer3FilterGetResponse"]