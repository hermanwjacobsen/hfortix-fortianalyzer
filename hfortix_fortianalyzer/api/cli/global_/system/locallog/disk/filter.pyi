"""Type stubs for cli.global.system.locallog.disk.filter"""
...
class CliGlobalSystemLocallogDiskFilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogDiskFilterGetResponse."""
...
class CliGlobalSystemLocallogDiskFilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogDiskFilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogDiskFilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogDiskFilter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.disk.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogDiskFilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogDiskFilter", "CliGlobalSystemLocallogDiskFilterGetResponse"]