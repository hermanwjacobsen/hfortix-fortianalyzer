"""Type stubs for cli.global.system.locallog.memory.filter"""
...
class CliGlobalSystemLocallogMemoryFilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogMemoryFilterGetResponse."""
...
class CliGlobalSystemLocallogMemoryFilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogMemoryFilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogMemoryFilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogMemoryFilter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.memory.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogMemoryFilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogMemoryFilter", "CliGlobalSystemLocallogMemoryFilterGetResponse"]