"""Type stubs for cli.global.system.locallog.fortianalyzer2.filter"""
...
class CliGlobalSystemLocallogFortianalyzer2FilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogFortianalyzer2FilterGetResponse."""
...
class CliGlobalSystemLocallogFortianalyzer2FilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogFortianalyzer2FilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogFortianalyzer2FilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogFortianalyzer2Filter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.fortianalyzer2.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogFortianalyzer2FilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogFortianalyzer2Filter", "CliGlobalSystemLocallogFortianalyzer2FilterGetResponse"]