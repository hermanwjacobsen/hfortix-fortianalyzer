"""Type stubs for cli.global.system.locallog.syslogd.filter"""
...
class CliGlobalSystemLocallogSyslogdFilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogSyslogdFilterGetResponse."""
...
class CliGlobalSystemLocallogSyslogdFilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogSyslogdFilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogSyslogdFilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogSyslogdFilter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.syslogd.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogSyslogdFilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogSyslogdFilter", "CliGlobalSystemLocallogSyslogdFilterGetResponse"]