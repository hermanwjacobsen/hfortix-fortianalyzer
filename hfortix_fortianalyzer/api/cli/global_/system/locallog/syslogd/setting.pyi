"""Type stubs for cli.global.system.locallog.syslogd.setting"""
...
class CliGlobalSystemLocallogSyslogdSettingGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogSyslogdSettingGetResponse."""
...
class CliGlobalSystemLocallogSyslogdSettingGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogSyslogdSettingGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogSyslogdSettingGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogSyslogdSetting:
    """FortiAnalyzer endpoint: cli.global.system.locallog.syslogd.setting"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogSyslogdSettingGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogSyslogdSetting", "CliGlobalSystemLocallogSyslogdSettingGetResponse"]