"""Type stubs for cli.global.system.locallog.syslogd3.filter"""
...
class CliGlobalSystemLocallogSyslogd3FilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogSyslogd3FilterGetResponse."""
...
class CliGlobalSystemLocallogSyslogd3FilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogSyslogd3FilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogSyslogd3FilterGetItem]: ...
...
class CliGlobalSystemLocallogSyslogd3Filter:
    ...
    def get(
        self,
    ) -> CliGlobalSystemLocallogSyslogd3FilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogSyslogd3Filter", "CliGlobalSystemLocallogSyslogd3FilterGetResponse"]