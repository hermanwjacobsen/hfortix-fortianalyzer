"""Type stubs for cli.global.system.locallog.syslogd3.setting"""
...
class CliGlobalSystemLocallogSyslogd3SettingGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogSyslogd3SettingGetResponse."""
...
class CliGlobalSystemLocallogSyslogd3SettingGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogSyslogd3SettingGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogSyslogd3SettingGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogSyslogd3Setting:
    """FortiAnalyzer endpoint: cli.global.system.locallog.syslogd3.setting"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogSyslogd3SettingGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogSyslogd3Setting", "CliGlobalSystemLocallogSyslogd3SettingGetResponse"]