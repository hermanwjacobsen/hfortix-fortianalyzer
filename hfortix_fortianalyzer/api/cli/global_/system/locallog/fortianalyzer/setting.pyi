"""Type stubs for cli.global.system.locallog.fortianalyzer.setting"""
...
class CliGlobalSystemLocallogFortianalyzerSettingGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogFortianalyzerSettingGetResponse."""
...
class CliGlobalSystemLocallogFortianalyzerSettingGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogFortianalyzerSettingGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogFortianalyzerSettingGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogFortianalyzerSetting:
    """FortiAnalyzer endpoint: cli.global.system.locallog.fortianalyzer.setting"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogFortianalyzerSettingGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogFortianalyzerSetting", "CliGlobalSystemLocallogFortianalyzerSettingGetResponse"]