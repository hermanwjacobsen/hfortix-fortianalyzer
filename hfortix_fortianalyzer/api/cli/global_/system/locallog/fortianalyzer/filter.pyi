"""Type stubs for cli.global.system.locallog.fortianalyzer.filter"""
...
class CliGlobalSystemLocallogFortianalyzerFilterGetItem:
    """Item yielded when iterating over CliGlobalSystemLocallogFortianalyzerFilterGetResponse."""
...
class CliGlobalSystemLocallogFortianalyzerFilterGetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocallogFortianalyzerFilterGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocallogFortianalyzerFilterGetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocallogFortianalyzerFilter:
    """FortiAnalyzer endpoint: cli.global.system.locallog.fortianalyzer.filter"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> CliGlobalSystemLocallogFortianalyzerFilterGetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocallogFortianalyzerFilter", "CliGlobalSystemLocallogFortianalyzerFilterGetResponse"]