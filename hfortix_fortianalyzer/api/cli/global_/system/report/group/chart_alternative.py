"""
FortiAnalyzer API endpoint: cli.global.system.report.group.chart-alternative
...
class CliGlobalSystemReportGroupChartAlternative:
    ...
    def get(
        ...
        if group is not None and chart_alternative is not None:
            url = "/cli/global/system/report/group/{group}/chart-alternative/{chart-alternative}"
            url = url.replace("{group}", group)
            url = url.replace("{chart-alternative}", str(chart_alternative))
        else:
            url = "/cli/global/system/report/group/{group}/chart-alternative"
            url = url.replace("{group}", group)
    ...
    def add(
        ...
        Args:
            group: group parameter
            chart_alternative: chart-alternative parameter
            chart_name: chart-name parameter
            chart_replace: chart-replace parameter
        ...
        if chart_name is not None:
            data["chart-name"] = chart_name
        if chart_replace is not None:
            data["chart-replace"] = chart_replace
    ...
    def delete(self, group: str, chart_alternative: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
