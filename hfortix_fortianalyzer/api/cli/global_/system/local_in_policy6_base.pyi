"""Type stubs for cli.global.system.local-in-policy6"""
...
class CliGlobalSystemLocalInPolicy6GetItem:
    """Item yielded when iterating over CliGlobalSystemLocalInPolicy6GetResponse."""
...
class CliGlobalSystemLocalInPolicy6GetResponse(FortiAnalyzerResponse):
    """Typed response for CliGlobalSystemLocalInPolicy6Get endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[CliGlobalSystemLocalInPolicy6GetItem]: ...
    def __len__(self) -> int: ...


class CliGlobalSystemLocalInPolicy6:
    """FortiAnalyzer endpoint: cli.global.system.local-in-policy6"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
        local_in_policy6: int | str | None = None,
        fields: list[Literal["action", "description", "id", "protocol"]] | None = None,
        filter: list[str] | None = None,
        loadsub: int | None = None,
        option: Literal["count", "syntax"] | None = None,
    ) -> CliGlobalSystemLocalInPolicy6GetResponse:
        """GET operation."""
        ...
...
__all__ = ["CliGlobalSystemLocalInPolicy6", "CliGlobalSystemLocalInPolicy6GetResponse"]