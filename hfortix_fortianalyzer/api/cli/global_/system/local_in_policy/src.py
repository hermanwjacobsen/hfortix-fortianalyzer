"""
FortiAnalyzer API endpoint: cli.global.system.local-in-policy.src
...
class CliGlobalSystemLocalInPolicySrc:
    ...
    def get(
        ...
        if local_in_policy is not None and src is not None:
            url = "/cli/global/system/local-in-policy/{local-in-policy}/src/{src}"
            url = url.replace("{local-in-policy}", local_in_policy)
            url = url.replace("{src}", str(src))
        else:
            url = "/cli/global/system/local-in-policy/{local-in-policy}/src"
            url = url.replace("{local-in-policy}", local_in_policy)
    ...
    def delete(self, local_in_policy: str, src: int | str | None = None) -> FortiAnalyzerResponse:
        """
        DELETE operation.
