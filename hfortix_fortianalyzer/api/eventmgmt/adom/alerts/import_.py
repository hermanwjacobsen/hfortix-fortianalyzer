"""
FortiAnalyzer API endpoint: eventmgmt.adom.alerts.import
...
class EventmgmtAdomAlertsImport:
    """
    FortiAnalyzer endpoint: eventmgmt.adom.alerts.import
    
    Request of importing basic handlers.
    ...
    def add(
        ...
        """
        # Build URL
        url = "/eventmgmt/adom/{adom}/alerts/import"
