"""
FortiAnalyzer API endpoint: eventmgmt.adom.basic-handlers.export
...
class EventmgmtAdomBasicHandlersExport:
    ...
    Request of exporting basic handlers.
    ...
    def get(
        ...
        Args:
            ...
            attachment: Objects that will be exported with basic handlers.
            data_format: The format of the exporting data.
            filter: A filter for selecting exporting basic handlers. <a href="objects.htm#filter">Filter Refrence</a>
        
        Returns:
            Response data from FortiAnalyzer API
        """
        # Build URL
        url = "/eventmgmt/adom/{adom}/basic-handlers/export"
