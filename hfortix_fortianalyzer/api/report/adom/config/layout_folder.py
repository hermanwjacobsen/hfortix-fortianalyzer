"""
FortiAnalyzer API endpoint: report.adom.config.layout-folder
...
class ReportAdomConfigLayoutFolder:
    ...
    support method: add, set, get, update, delete<br>table: /report/config/layout-folder<br>object: /report/config/layout-folder/&lt;folder-id&gt;
