"""
FortiAnalyzer API endpoint: report.adom.config.chart
...
class ReportAdomConfigChart:
    ...
    support method: add, set, get, update, delete<br>table: /report/config/chart<br>object: /report/config/chart/&lt;name&gt;
    ...
    def add(
        ...
        """
        # Build URL
        url = "/report/adom/{adom}/config/chart"
