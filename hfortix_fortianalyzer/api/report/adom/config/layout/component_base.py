"""
FortiAnalyzer API endpoint: report.adom.config.layout.component
...
class ReportAdomConfigLayoutComponent:
    ...
    support method: add, set, get, update, delete<br>table: /report/config/layout/&lt;layout-id&gt;/component<br>object: /report/config/layout/&lt;layout-id&gt;/component/&lt;component-id&gt;
    ...
    def add(
        ...
        """
        # Build URL
        url = "/report/adom/{adom}/config/layout/{layout-id}/component"
