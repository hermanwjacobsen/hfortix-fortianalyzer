...
class SysStatusGetItem:
    """Item yielded when iterating over SysStatusGetResponse."""
...
class SysStatusGetResponse(FortiAnalyzerResponse):
    """Typed response for SysStatusGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[SysStatusGetItem]: ...
    def __len__(self) -> int: ...


class SysStatus:
    """FortiAnalyzer endpoint: sys.status"""

    def __init__(self, client: HTTPClientJSONRPC) -> None: ...

    def get(
        self,
    ) -> SysStatusGetResponse:
        """GET operation."""
        ...


__all__ = ["SysStatus", "SysStatusGetResponse"]