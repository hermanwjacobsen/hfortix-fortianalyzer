"""
FortiAnalyzer API endpoint: dvmdb.adom.device.ha_slave
...
class DvmdbAdomDeviceHaSlave:
    ...
    def get(
        ...
        if adom is not None and device is not None and ha_slave is not None:
            url = "/dvmdb/adom/{adom}/device/{device}/ha_slave/{ha_slave}"
