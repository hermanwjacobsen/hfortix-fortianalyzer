"""Type stubs for dvmdb.adom.device"""
...
class DvmdbAdomDeviceGetItem:
    """Item yielded when iterating over DvmdbAdomDeviceGetResponse."""
...
class DvmdbAdomDeviceGetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomDeviceGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[DvmdbAdomDeviceGetItem]: ...
    def __len__(self) -> int: ...


class DvmdbAdomDeviceSetItem:
    """Item yielded when iterating over DvmdbAdomDeviceSetResponse."""
...
class DvmdbAdomDeviceSetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomDeviceSet endpoint with autocomplete support."""
    ...
    def __getitem__(self, key: str) -> Any: ...
    def __contains__(self, key: str) -> bool: ...
    def __iter__(self) -> Iterator[DvmdbAdomDeviceSetItem]: ...
    def __len__(self) -> int: ...
...
class DvmdbAdomDevice:
    ...
    def set(
        ...
        vdom: list[dict[str, Any]] | None = None,
...
__all__ = ["DvmdbAdomDevice", "DvmdbAdomDeviceGetResponse", "DvmdbAdomDeviceSetResponse"]