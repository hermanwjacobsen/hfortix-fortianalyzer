"""Type stubs for dvmdb.adom.group"""
...
class DvmdbAdomGroupAddItem:
    """Item yielded when iterating over DvmdbAdomGroupAddResponse."""
...
class DvmdbAdomGroupAddResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomGroupAdd endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[DvmdbAdomGroupAddItem]: ...
    def __len__(self) -> int: ...


class DvmdbAdomGroupGetItem:
    """Item yielded when iterating over DvmdbAdomGroupGetResponse."""
    ...
    @property
    def type(self) -> Literal["normal", "default", "auto", "cluster", "fabric"]: ...
...
class DvmdbAdomGroupGetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomGroupGet endpoint with autocomplete support."""
    ...
    @property
    def type(self) -> Literal["normal", "default", "auto", "cluster", "fabric"] | None:
        """Field: type"""
        ...
    ...
    def __getitem__(self, key: str) -> Any: ...
    def __contains__(self, key: str) -> bool: ...
    def __iter__(self) -> Iterator[DvmdbAdomGroupGetItem]: ...
    def __len__(self) -> int: ...


class DvmdbAdomGroup:
    """FortiAnalyzer endpoint: dvmdb.adom.group"""
...
__all__ = ["DvmdbAdomGroup", "DvmdbAdomGroupAddResponse", "DvmdbAdomGroupGetResponse"]