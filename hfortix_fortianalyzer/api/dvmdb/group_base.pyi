...
class DvmdbGroupAddItem:
    """Item yielded when iterating over DvmdbGroupAddResponse."""
...
class DvmdbGroupAddResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbGroupAdd endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[DvmdbGroupAddItem]: ...
    def __len__(self) -> int: ...


class DvmdbGroupGetItem:
    """Item yielded when iterating over DvmdbGroupGetResponse."""
...
class DvmdbGroupGetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbGroupGet endpoint with autocomplete support."""
    ...
    def __getitem__(self, key: str) -> Any: ...
    def __contains__(self, key: str) -> bool: ...
    def __iter__(self) -> Iterator[DvmdbGroupGetItem]: ...
    def __len__(self) -> int: ...
...
__all__ = ["DvmdbGroup", "DvmdbGroupGetResponse", "DvmdbGroupAddResponse"]