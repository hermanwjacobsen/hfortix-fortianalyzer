...
class DvmdbAdomAddItem:
    """Item yielded when iterating over DvmdbAdomAddResponse."""
...
class DvmdbAdomAddResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomAdd endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[DvmdbAdomAddItem]: ...
    def __len__(self) -> int: ...


class DvmdbAdomGetItem:
    """Item yielded when iterating over DvmdbAdomGetResponse."""
...
class DvmdbAdomGetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbAdomGet endpoint with autocomplete support."""
    ...
    def __getitem__(self, key: str) -> Any: ...
    def __contains__(self, key: str) -> bool: ...
    def __iter__(self) -> Iterator[DvmdbAdomGetItem]: ...
    def __len__(self) -> int: ...
...
class DvmdbAdom:
    ...
    def get(
        ...
        fields: list[Literal["create_time", "desc", "flags", "lock_override", "log_db_retention_hours", "log_disk_quota", "log_disk_quota_alert_thres", "log_disk_quota_split_ratio", "log_file_retention_hours", "mode", "mr", "name", "os_ver", "primary_dns_ip4", "primary_dns_ip6_1", "primary_dns_ip6_2", "primary_dns_ip6_3", "primary_dns_ip6_4", "restricted_prds", "secondary_dns_ip4", "secondary_dns_ip6_1", "secondary_dns_ip6_2", "secondary_dns_ip6_3", "secondary_dns_ip6_4", "state", "tz", "uuid", "workspace_mode"]] | None = None,
