...
class DvmdbDeviceGetItem:
    """Item yielded when iterating over DvmdbDeviceGetResponse."""
...
class DvmdbDeviceGetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbDeviceGet endpoint with autocomplete support."""
    ...
    def __iter__(self) -> Iterator[DvmdbDeviceGetItem]: ...
    def __len__(self) -> int: ...


class DvmdbDeviceSetItem:
    """Item yielded when iterating over DvmdbDeviceSetResponse."""
...
class DvmdbDeviceSetResponse(FortiAnalyzerResponse):
    """Typed response for DvmdbDeviceSet endpoint with autocomplete support."""
    ...
    def __getitem__(self, key: str) -> Any: ...
    def __contains__(self, key: str) -> bool: ...
    def __iter__(self) -> Iterator[DvmdbDeviceSetItem]: ...
    def __len__(self) -> int: ...
...
__all__ = ["DvmdbDevice", "DvmdbDeviceSetResponse", "DvmdbDeviceGetResponse"]