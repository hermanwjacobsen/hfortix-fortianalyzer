"""
FortiAnalyzer API endpoint: dvm.cmd.del.dev-list
...
class DvmCmdDelDevList:
    ...
    def exec(
        ...
        Args:
            ...
            del_dev_member_list: del-dev-member-list parameter
        ...
        if adom is not None:
            data["adom"] = adom
        if del_dev_member_list is not None:
            data["del-dev-member-list"] = del_dev_member_list
