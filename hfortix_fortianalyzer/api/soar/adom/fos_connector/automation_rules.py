"""
FortiAnalyzer API endpoint: soar.adom.fos-connector.automation-rules
...
class SoarAdomFosConnectorAutomationRules:
    ...
    Get FOS-connector automation rules.
    ...
    def get(self, adom: str, apiver: int = 3) -> FortiAnalyzerResponse:
        ...
        """
        # Build URL
        url = "/soar/adom/{adom}/fos-connector/automation-rules"
