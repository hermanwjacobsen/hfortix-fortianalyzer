"""
FortiAnalyzer API endpoint: soar.adom.subnet.export
...
class SoarAdomSubnetExport:
    ...
    Request of exporting subnets and subnet groups.
    ...
    def get(
        ...
        Args:
            ...
            filter: A filter for selecting exporting subnets and subnet groups
        
        Returns:
            Response data from FortiAnalyzer API
        """
        # Build URL
        url = "/soar/adom/{adom}/subnet/export"
